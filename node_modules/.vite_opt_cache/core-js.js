...
_export({ global: true, constructor: true, arity: 2, forced: FORCED$2 }, {
...
var FORCED$4 = NEGATIVE_ZERO || !arrayMethodIsStrict('indexOf');
...
var FORCED$6 = NEGATIVE_ZERO$1 || !STRICT_METHOD$2;
...
var createMethod$3 = function (IS_RIGHT) {
  return function (that, callbackfn, argumentsLength, memo) {
    ...
    var length = lengthOfArrayLike(O);
    aCallable(callbackfn);
    if (length === 0 && argumentsLength < 2) throw new $TypeError$c(REDUCE_EMPTY);
    ...
    if (argumentsLength < 2) while (true) {
      ...
      if (IS_RIGHT ? index < 0 : length <= index) {
        throw new $TypeError$c(REDUCE_EMPTY);
      }
    }
...
var FORCED$8 = CHROME_BUG || !arrayMethodIsStrict('reduce');
...
var FORCED$9 = CHROME_BUG$1 || !arrayMethodIsStrict('reduceRight');
...
var test$2 = [];
var nativeSort = functionUncurryThis(test$2.sort);
var push$5 = functionUncurryThis(test$2.push);
...
var FORCED$a = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD$4 || !STABLE_SORT;
...
_export({ target: 'Array', proto: true }, {
  toSorted: function toSorted(compareFn) {
    if (compareFn !== undefined) aCallable(compareFn);
    var O = toIndexedObject(this);
    var A = arrayFromConstructorAndList($Array$5, O);
...
var FORCED$b = INCORRECT_RESULT || !properErrorOnNonWritableLength$1();

// `Array.prototype.unshift` method
// https://tc39.es/ecma262/#sec-array.prototype.unshift
_export({ target: 'Array', proto: true, arity: 1, forced: FORCED$b }, {
  // eslint-disable-next-line no-unused-vars -- required for `.length`
...
_export({ target: 'Array', proto: true }, {
  'with': function (index, value) {
    return arrayWith(toIndexedObject(this), $Array$7, index, value);
  }
});
...
var arrayBufferByteLength = functionUncurryThisAccessor(ArrayBuffer.prototype, 'byteLength', 'get') || function (O) {
  if (classofRaw(O) !== 'ArrayBuffer') throw new $TypeError$f('ArrayBuffer expected');
  return O.byteLength;
};

var slice = functionUncurryThis(ArrayBuffer.prototype.slice);
...
var structuredCloneProperTransfer = !!structuredClone && !fails(function () {
...
var DataViewPrototype$2 = DataView$2.prototype;
var slice$1 = functionUncurryThis(ArrayBufferPrototype$2.slice);
var isResizable = functionUncurryThisAccessor(ArrayBufferPrototype$2, 'resizable', 'get');
var maxByteLength = functionUncurryThisAccessor(ArrayBufferPrototype$2, 'maxByteLength', 'get');
var getInt8 = functionUncurryThis(DataViewPrototype$2.getInt8);
...
var arrayBufferTransfer = (structuredCloneProperTransfer || detachTransferable) && function (arrayBuffer, newLength, preserveResizability) {
  ...
  if (structuredCloneProperTransfer) {
    arrayBuffer = structuredClone$2(arrayBuffer, { transfer: [arrayBuffer] });
...
var $Date = Date;
var thisTimeValue = functionUncurryThis($Date.prototype.getTime);
...
var setFullYear = functionUncurryThis(DatePrototype.setFullYear);
...
var thisTimeValue$2 = functionUncurryThis(DatePrototype$1.getTime);
...
var getUTCSeconds = functionUncurryThis(DatePrototype$1.getUTCSeconds);
...
var dateToIsoString = (fails(function () {
  ...
  if (!$isFinite(thisTimeValue$2(this))) throw new $RangeError$3('Invalid time value');
  var date = this;
  var year = getUTCFullYear(date);
  var milliseconds = getUTCMilliseconds(date);
  var sign = year < 0 ? '-' : year > 9999 ? '+' : '';
  return sign + padStart(abs$2(year), sign ? 6 : 4, 0) +
...
_export({ target: 'Date', proto: true, arity: 1, forced: FORCED$d }, {
  // eslint-disable-next-line no-unused-vars -- required for `.length`
...
var dateToPrimitive = function (hint) {
  ...
  else if (hint !== 'number') throw new $TypeError$g('Incorrect hint');
...
// https://tc39.es/ecma262/#sec-date.prototype-@@toprimitive
if (!hasOwnProperty_1(DatePrototype$2, TO_PRIMITIVE$1)) {
  defineBuiltIn(DatePrototype$2, TO_PRIMITIVE$1, dateToPrimitive);
}
...
var nativeDateToString = functionUncurryThis(DatePrototype$3[TO_STRING]);
var thisTimeValue$3 = functionUncurryThis(DatePrototype$3.getTime);

// `Date.prototype.toString` method
// https://tc39.es/ecma262/#sec-date.prototype.tostring
if (String(new Date(NaN)) !== INVALID_DATE) {
  defineBuiltIn(DatePrototype$3, TO_STRING, function toString() {
    var value = thisTimeValue$3(this);
    // eslint-disable-next-line no-self-compare -- NaN check
...
_export({ global: true }, {
  escape: function escape(string) {
    ...
    var chr, code;
    while (index < length) {
      chr = charAt$1(str, index++);
      if (exec$2(raw, chr)) {
        result += chr;
      } else {
        code = charCodeAt$1(chr, 0);
        if (code < 256) {
          result += '%' + hex(code, 2);
        } else {
...
if (!(HAS_INSTANCE in FunctionPrototype$3)) {
  objectDefineProperty.f(FunctionPrototype$3, HAS_INSTANCE, { value: makeBuiltIn_1(function (O) {
    if (!isCallable(this) || !isObject(O)) return false;
    var P = this.prototype;
    return isObject(P) ? objectIsPrototypeOf(P, O) : O instanceof this;
  }, HAS_INSTANCE) });
}
...
var functionToString$1 = functionUncurryThis(FunctionPrototype$4.toString);
...
if (descriptors && !FUNCTION_NAME_EXISTS) {
  defineBuiltInAccessor(FunctionPrototype$4, NAME$1, {
    configurable: true,
    get: function () {
      try {
...
_export({ target: 'Map', stat: true, forced: isPure }, {
  groupBy: function groupBy(items, callbackfn) {
    ...
    iterate(items, function (value) {
      ...
      if (!has$1(map, key)) set$2(map, key, [value]);
      else push$6(get$2(map, key), value);
    });
    return map;
  }
});
...
var mathLog1p = Math.log1p || function log1p(x) {
  var n = +x;
  return n > -1e-8 && n < 1e-8 ? n - n * n / 2 : log$1(1 + n);
};
...
_export({ target: 'Math', stat: true, forced: FORCED$e }, {
  acosh: function acosh(x) {
    ...
    return n < 1 ? NaN : n > 94906265.62425156
      ? log$2(n) + LN2$1
      : mathLog1p(n - 1 + sqrt(n - 1) * sqrt(n + 1));
  }
});
...
function asinh(x) {
  var n = +x;
  return !isFinite(n) || n === 0 ? n : n < 0 ? -asinh(-n) : log$3(n + sqrt$1(n * n + 1));
}

var FORCED$f = !($asinh && 1 / $asinh(0) > 0);
...
var FORCED$g = !($atanh && 1 / $atanh(-0) < 0);
...
_export({ target: 'Math', stat: true }, {
  cbrt: function cbrt(x) {
    var n = +x;
    return mathSign(n) * pow$1(abs$3(n), 1 / 3);
  }
});
...
_export({ target: 'Math', stat: true }, {
  clz32: function clz32(x) {
    var n = x >>> 0;
    return n ? 31 - floor$3(log$5(n + 0.5) * LOG2E) : 32;
  }
});
...
var FORCED$h = !$cosh || $cosh(710) === Infinity;
...
_export({ target: 'Math', stat: true, arity: 2, forced: FORCED$i }, {
  // eslint-disable-next-line no-unused-vars -- required for `.length`
...
_export({ target: 'Math', stat: true, forced: FORCED$k }, {
  sinh: function sinh(x) {
    var n = +x;
    return abs$6(n) < 1 ? (mathExpm1(n) - mathExpm1(-n)) / 2 : (exp$1(n - 1) - exp$1(-n - 1)) * (E$1 / 2);
  }
});
...
var FORCED$l = isForced_1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'));
...
if (FORCED$l && !isPure) NumberPrototype.constructor = NumberWrapper;

_export({ global: true, constructor: true, wrap: true, forced: FORCED$l }, {
...
if (FORCED$l || isPure) copyConstructorProperties$1(path[NUMBER], NativeNumber);
...
var FORCED$m = 1 / $parseFloat(whitespaces + '-0') !== -Infinity
...
var hex$1 = /^[+-]?0x/i;
var exec$3 = functionUncurryThis(hex$1.exec);
var FORCED$n = $parseInt(whitespaces + '08') !== 8 || $parseInt(whitespaces + '0x16') !== 22
  // MS Edge 18- broken with boxed symbols
  || (ITERATOR$6 && !fails(function () { $parseInt(Object(ITERATOR$6)); }));

// `parseInt` method
// https://tc39.es/ecma262/#sec-parseint-string-radix
var numberParseInt = FORCED$n ? function parseInt(string, radix) {
  var S = trim$2(toString_1(string));
  return $parseInt(S, (radix >>> 0) || (exec$3(hex$1, S) ? 16 : 10));
} : $parseInt;
...
var FORCED$o = !ROUNDS_PROPERLY || !throwsOnInfinityFraction() || !properNonFiniteThisCheck();

// `Number.prototype.toExponential` method
// https://tc39.es/ecma262/#sec-number.prototype.toexponential
_export({ target: 'Number', proto: true, forced: FORCED$o }, {
  toExponential: function toExponential(fractionDigits) {
    ...
    if (f < 0 || f > 20) throw new $RangeError$4('Incorrect fraction digits');
    ...
    if (f !== 0) {
      m = stringSlice$4(m, 0, 1) + '.' + stringSlice$4(m, 1);
    }
    if (e === 0) {
      c = '+';
      d = '0';
...
_export({ target: 'Number', proto: true, forced: FORCED$p }, {
  toFixed: function toFixed(fractionDigits) {
    ...
    if (number <= -1e21 || number >= 1e21) return $String$7(number);
    if (number < 0) {
      sign = '-';
      number = -number;
    }
...
_export({ target: 'Number', proto: true, forced: FORCED$q }, {
...
var FORCED$r = !descriptors || fails(function () { nativeGetOwnPropertyDescriptor$1(1); });

// `Object.getOwnPropertyDescriptor` method
// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
_export({ target: 'Object', stat: true, forced: FORCED$r, sham: !descriptors }, {
...
var FORCED$s = arrayBufferNonExtensible || fails(function () { $isFrozen(1); });

// `Object.isFrozen` method
// https://tc39.es/ecma262/#sec-object.isfrozen
_export({ target: 'Object', stat: true, forced: FORCED$s }, {
...
var FORCED$t = arrayBufferNonExtensible || fails(function () { $isSealed(1); });

// `Object.isSealed` method
// https://tc39.es/ecma262/#sec-object.issealed
_export({ target: 'Object', stat: true, forced: FORCED$t }, {
...
var FAILS_ON_PRIMITIVES$5 = fails(function () { $preventExtensions(1); });
...
if (descriptors && getPrototypeOf && setPrototypeOf && !(PROTO in ObjectPrototype$4)) try {
  defineBuiltInAccessor(ObjectPrototype$4, PROTO, {
    configurable: true,
...
var FAILS_ON_PRIMITIVES$6 = fails(function () { $seal(1); });
...
var safeGetBuiltIn = function (name) {
  ...
  var descriptor = getOwnPropertyDescriptor$6(global_1, name);
...
_export({ target: 'Reflect', stat: true, forced: FORCED$u, sham: FORCED$u }, {
  construct: function construct(Target, args /* , newTarget */) {
    ...
    var instance = objectCreate(isObject(proto) ? proto : ObjectPrototype$5);
...
function get$3(target, propertyKey /* , receiver */) {
  ...
  if (isObject(prototype = objectGetPrototypeOf(target))) return get$3(prototype, propertyKey, receiver);
}
...
var exec$4 = functionUncurryThis(RegExpPrototype$1.exec);
...
if (descriptors && regexpUnsupportedDotAll) {
  defineBuiltInAccessor(RegExpPrototype$2, 'dotAll', {
    configurable: true,
    get: function dotAll() {
      ...
      throw new $TypeError$j('Incompatible receiver, RegExp required');
    }
  });
}
...
var FORCED$v = descriptors && fails(function () {
...
// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
if (FORCED$v) defineBuiltInAccessor(RegExpPrototype$3, 'flags', {
  configurable: true,
  get: regexpFlags
});

var MISSED_STICKY$2 = regexpStickyHelpers.MISSED_STICKY;
...
if (descriptors && MISSED_STICKY$2) {
  defineBuiltInAccessor(RegExpPrototype$4, 'sticky', {
    configurable: true,
    get: function sticky() {
      ...
      throw new $TypeError$k('Incompatible receiver, RegExp required');
    }
  });
}
...
if (NOT_GENERIC || INCORRECT_NAME) {
  defineBuiltIn(RegExpPrototype$5, TO_STRING$1, function toString() {
    var R = anObject(this);
...
_export({ target: 'String', proto: true, forced: FORCED$w }, {
  at: function at(index) {
    var S = toString_1(requireObjectCoercible(this));
    var len = S.length;
    var relativeIndex = toIntegerOrInfinity(index);
...
var notARegexp = function (it) {
  if (isRegexp(it)) {
    throw new $TypeError$l("The method doesn't accept regular expressions");
  } return it;
};
...
var MDN_POLYFILL_BUG =  !CORRECT_IS_REGEXP_LOGIC && !!function () {
  var descriptor = getOwnPropertyDescriptor$8(String.prototype, 'endsWith');
...
var getInternalState$6 = internalState.getterFor(STRING_ITERATOR);
...
var fixRegexpWellKnownSymbolLogic = function (KEY, exec, FORCED, SHAM) {
  ...
  if (
    ...
    var methods = exec(SYMBOL, ''[KEY], function (nativeMethod, regexp, str, arg2, forceStringMethod) {
      ...
      if ($exec === regexpExec || $exec === RegExpPrototype$6.exec) {
    ...
    defineBuiltIn(RegExpPrototype$6, SYMBOL, methods[1]);
  }

  if (SHAM) createNonEnumerableProperty(RegExpPrototype$6[SYMBOL], 'sham', true);
};
...
_export({ target: 'String', proto: true, forced: WORKS_WITH_NON_GLOBAL_REGEX }, {
  matchAll: function matchAll(regexp) {
    ...
    if (!isNullOrUndefined(regexp)) {
      if (isRegexp(regexp)) {
        ...
        if (!~stringIndexOf$2(flags, 'g')) throw new $TypeError$n('`.matchAll` does not allow non-global regexes');
      }
 ...
 MATCH_ALL in RegExpPrototype$7 || defineBuiltIn(RegExpPrototype$7, MATCH_ALL, $matchAll);
...
_export({ target: 'String', stat: true }, {
  raw: function raw(template) {
    ...
    var i = 0;
    while (true) {
      push$a(elements, toString_1(rawTemplate[i++]));
      if (i === literalSegments) return join$2(elements, '');
      if (i < argumentsLength) push$a(elements, toString_1(arguments[i]));
    }
  }
});
  ...
  return [
    ...
    function (string, replaceValue) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        var position = max$4(min$8(toIntegerOrInfinity(result.index), S.length), 0);
        var captures = [];
        var replacement;
  ...
  replaceAll: function replaceAll(searchValue, replaceValue) {
    ...
    if (!isNullOrUndefined(searchValue)) {
      ...
      if (IS_REG_EXP) {
        ...
        if (!~indexOf$2(flags, 'g')) throw new $TypeError$o('`.replaceAll` does not allow non-global regexes');
      }
  ...
  return [
    ...
    function (string, limit) {
      ...
      while (q < S.length) {
        ...
        var z = regexpExecAbstract(splitter, UNSUPPORTED_Y$3 ? stringSlice$c(S, q) : S);
        var e;
        if (
          z === null ||
          (e = min$9(toLength(splitter.lastIndex + (UNSUPPORTED_Y$3 ? q : 0)), S.length)) === p
        ) {
          q = advanceStringIndex(S, q, unicodeMatching);
        } else {
          push$c(A, stringSlice$c(S, p, q));
...
var stringSlice$d = functionUncurryThisClause(''.slice);
var min$a = Math.min;

var CORRECT_IS_REGEXP_LOGIC$1 = correctIsRegexpLogic('startsWith');
// https://github.com/zloirock/core-js/pull/702
var MDN_POLYFILL_BUG$1 =  !CORRECT_IS_REGEXP_LOGIC$1 && !!function () {
  var descriptor = getOwnPropertyDescriptor$9(String.prototype, 'startsWith');
  return descriptor && !descriptor.writable;
}();
...
_export({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG$1 && !CORRECT_IS_REGEXP_LOGIC$1 }, {
  startsWith: function startsWith(searchString /* , position = 0 */) {
    var that = toString_1(requireObjectCoercible(this));
    notARegexp(searchString);
    var index = toLength(min$a(arguments.length > 1 ? arguments[1] : undefined, that.length));
    var search = toString_1(searchString);
    return stringSlice$d(that, index, index + search.length) === search;
  }
});
...
var FORCED$x = !''.substr || 'ab'.substr(-1) !== 'b';

// `String.prototype.substr` method
// https://tc39.es/ecma262/#sec-string.prototype.substr
_export({ target: 'String', proto: true, forced: FORCED$x }, {
  substr: function substr(start, length) {
    ...
    if (intStart < 0) intStart = max$6(size + intStart, 0);
    intLength = length === undefined ? size : toIntegerOrInfinity(length);
    if (intLength <= 0 || intLength === Infinity) return '';
    intEnd = min$b(intStart + intLength, size);
    return intStart >= intEnd ? '' : stringSlice$e(that, intStart, intEnd);
  }
});
...
_export({ target: 'String', proto: true, forced: TO_STRING_CONVERSION_BUG }, {
  toWellFormed: function toWellFormed() {
    ...
    var length = S.length;
    var result = $Array$9(length);
    for (var i = 0; i < length; i++) {
      var charCode = charCodeAt$5(S, i);
      // single UTF-16 code unit
      if ((charCode & 0xF800) !== 0xD800) result[i] = charAt$a(S, i);
      // unpaired surrogate
      else if (charCode >= 0xDC00 || i + 1 >= length || (charCodeAt$5(S, i + 1) & 0xFC00) !== 0xDC00) result[i] = REPLACEMENT_CHARACTER;
      // surrogate pair
      else {
...
var createHtml = function (string, tag, attribute, value) {
  ...
  var p1 = '<' + tag;
  if (attribute !== '') p1 += ' ' + attribute + '="' + replace$8(toString_1(value), quot, '&quot;') + '"';
  return p1 + '>' + S + '</' + tag + '>';
};
...
var ArrayBuffer$4 = global_1.ArrayBuffer;
...
var typedArrayConstructorsRequireWrappers = !NATIVE_ARRAY_BUFFER_VIEWS$2 || !fails(function () {
  ...
  return new Int8Array$2(new ArrayBuffer$4(2), 1, undefined).length !== 1;
});
...
var toOffset = function (it, BYTES) {
  ...
  if (offset % BYTES) throw new $RangeError$8('Wrong offset');
  return offset;
};
...
var toBigInt = function (argument) {
  ...
  if (typeof prim == 'number') throw new $TypeError$p("Can't convert number to bigint");
...
exportTypedArrayMethod$2('copyWithin', function copyWithin(target, start /* , end */) {
  return u$ArrayCopyWithin(aTypedArray$2(this), target, start, arguments.length > 2 ? arguments[2] : undefined);
});
...
exportTypedArrayMethod$8('findLast', function findLast(predicate /* , thisArg */) {
  return $findLast$1(aTypedArray$8(this), predicate, arguments.length > 1 ? arguments[1] : undefined);
});
...
exportTypedArrayMethod$9('findLastIndex', function findLastIndex(predicate /* , thisArg */) {
  return $findLastIndex$1(aTypedArray$9(this), predicate, arguments.length > 1 ? arguments[1] : undefined);
});
...
exportTypedArrayMethod$a('forEach', function forEach(callbackfn /* , thisArg */) {
  $forEach$2(aTypedArray$a(this), callbackfn, arguments.length > 1 ? arguments[1] : undefined);
});
...
exportTypedArrayMethod$b('includes', function includes(searchElement /* , fromIndex */) {
  return $includes$1(aTypedArray$b(this), searchElement, arguments.length > 1 ? arguments[1] : undefined);
});
...
exportTypedArrayMethod$c('indexOf', function indexOf(searchElement /* , fromIndex */) {
  return $indexOf$1(aTypedArray$c(this), searchElement, arguments.length > 1 ? arguments[1] : undefined);
});
...
var GENERIC = !fails(function () {
  TypedArrayPrototype$1[ITERATOR$7].call([1]);
});

var ITERATOR_IS_VALUES = !!TypedArrayPrototype$1
  && TypedArrayPrototype$1.values
  && TypedArrayPrototype$1[ITERATOR$7] === TypedArrayPrototype$1.values
...
exportTypedArrayMethod$d(ITERATOR$7, typedArrayValues, GENERIC || !ITERATOR_IS_VALUES, { name: 'values' });
...
exportTypedArrayMethod$f('lastIndexOf', function lastIndexOf(searchElement /* , fromIndex */) {
  var length = arguments.length;
  return functionApply(arrayLastIndexOf, aTypedArray$f(this), length > 1 ? [searchElement, arguments[1]] : [searchElement]);
});
...
exportTypedArrayMethod$g('map', function map(mapfn /* , thisArg */) {
  return $map$1(aTypedArray$g(this), mapfn, arguments.length > 1 ? arguments[1] : undefined, function (O, length) {
...
exportTypedArrayMethod$h('reduce', function reduce(callbackfn /* , initialValue */) {
  var length = arguments.length;
  return $reduce$1(aTypedArray$h(this), callbackfn, length, length > 1 ? arguments[1] : undefined);
});
...
exportTypedArrayMethod$i('reduceRight', function reduceRight(callbackfn /* , initialValue */) {
  var length = arguments.length;
  return $reduceRight$1(aTypedArray$i(this), callbackfn, length, length > 1 ? arguments[1] : undefined);
});
...
exportTypedArrayMethod$j('reverse', function reverse() {
  var that = this;
  var length = aTypedArray$j(that).length;
...
exportTypedArrayMethod$k('set', function set(arrayLike /* , offset */) {
  aTypedArray$k(this);
...
exportTypedArrayMethod$l('slice', function slice(start, end) {
  var list = arraySlice(aTypedArray$l(this), start, end);
...
exportTypedArrayMethod$m('some', function some(callbackfn /* , thisArg */) {
  return $some$1(aTypedArray$m(this), callbackfn, arguments.length > 1 ? arguments[1] : undefined);
});
...
exportTypedArrayMethod$n('sort', function sort(comparefn) {
  if (comparefn !== undefined) aCallable(comparefn);
  if (STABLE_SORT$1) return nativeSort$1(this, comparefn);

  return arraySort(aTypedArray$n(this), getSortCompare$1(comparefn));
...
exportTypedArrayMethod$o('subarray', function subarray(begin, end) {
...
exportTypedArrayMethod$p('toLocaleString', function toLocaleString() {
  return functionApply(
    $toLocaleString,
    TO_LOCALE_STRING_BUG ? arraySlice(aTypedArray$p(this)) : aTypedArray$p(this),
...
exportTypedArrayMethod$q('toReversed', function toReversed() {
  return arrayToReversed(aTypedArray$q(this), getTypedArrayConstructor$2(this));
});
...
var sort$2 = functionUncurryThis(arrayBufferViewCore.TypedArrayPrototype.sort);

// `%TypedArray%.prototype.toSorted` method
// https://tc39.es/ecma262/#sec-%typedarray%.prototype.tosorted
exportTypedArrayMethod$r('toSorted', function toSorted(compareFn) {
  if (compareFn !== undefined) aCallable(compareFn);
...
exportTypedArrayMethod$s('toString', arrayToString, IS_NOT_ARRAY_METHOD);
...
exportTypedArrayMethod$t('with', { 'with': function (index, value) {
  var O = aTypedArray$s(this);
  var relativeIndex = toIntegerOrInfinity(index);
  var actualValue = isBigIntArray(O) ? toBigInt(value) : +value;
  return arrayWith(O, getTypedArrayConstructor$4(O), relativeIndex, actualValue);
} }['with'], !PROPER_ORDER);
    ...
    while (index < length) {
      ...
      if (chr === '%') {
        if (charAt$b(str, index) === 'u') {
          part = stringSlice$f(str, index + 1, index + 5);
          if (exec$5(hex4, part)) {
          ...
          part = stringSlice$f(str, index, index + 2);
          if (exec$5(hex2, part)) {
            result += fromCharCode$1(parseInt(part, 16));
            index += 2;
            continue;
...
var $SuppressedError = function SuppressedError(error, suppressed, message) {
  ...
  var that;
  if (objectSetPrototypeOf) {
    that = objectSetPrototypeOf(new $Error$2(), isInstance ? objectGetPrototypeOf(this) : SuppressedErrorPrototype);
  } else {
    that = isInstance ? this : objectCreate(SuppressedErrorPrototype);
    createNonEnumerableProperty(that, TO_STRING_TAG$5, 'Error');
  }
  if (message !== undefined) createNonEnumerableProperty(that, 'message', normalizeStringArgument(message));
...
if (objectSetPrototypeOf) objectSetPrototypeOf($SuppressedError, $Error$2);
else copyConstructorProperties($SuppressedError, $Error$2, { name: true });

var SuppressedErrorPrototype = $SuppressedError.prototype = objectCreate($Error$2.prototype, {
...
var getInternalState$8 = internalState.getterFor(ASYNC_FROM_SYNC_ITERATOR);
...
var arrayIterator$1 = functionUncurryThis(getBuiltInPrototypeMethod('Array', 'values'));
var arrayIteratorNext = functionUncurryThis(arrayIterator$1([]).next);
...
var SafeArrayIterator = function (O) {
  this.iterator = arrayIterator$1(O);
};
...
var arrayFromAsync = function fromAsync(asyncItems /* , mapfn = undefined, thisArg = undefined */) {
  ...
  return new (getBuiltIn('Promise'))(function (resolve) {
    ...
    var usingAsyncIterator = getMethod(O, ASYNC_ITERATOR$2);
...
var arrayGroupToMap = function groupToMap(callbackfn /* , thisArg */) {
  ...
  for (;length > index; index++) {
    ...
    if (mapHas(map, key)) push$e(mapGet(map, key), value);
...
var next = entries(new Map$3()).next;
...
var addDisposableResource = function (disposable, V, hint, method) {
  ...
  push$g(disposable.stack, resource);
};
...
var $AsyncDisposableStack = function AsyncDisposableStack() {
  setInternalState$9(anInstance(this, AsyncDisposableStackPrototype), {
...
defineBuiltIn(AsyncDisposableStackPrototype, TO_STRING_TAG$6, ASYNC_DISPOSABLE_STACK, { nonWritable: true });
...
var AsyncIteratorConstructor = function AsyncIterator() {
  ...
  if (objectGetPrototypeOf(this) === asyncIteratorPrototype) throw new $TypeError$q('Abstract class AsyncIterator not directly constructable');
};

AsyncIteratorConstructor.prototype = asyncIteratorPrototype;

if (!hasOwnProperty_1(asyncIteratorPrototype, TO_STRING_TAG$7)) {
  createNonEnumerableProperty(asyncIteratorPrototype, TO_STRING_TAG$7, 'AsyncIterator');
}
...
var createAsyncIteratorProxyPrototype = function (IS_ITERATOR) {
  ...
  var getStateOrEarlyExit = function (that) {
    ...
    if (stateError || (IS_GENERATOR && state.done)) {
      return { exit: true, value: stateError ? Promise$3.reject(state) : Promise$3.resolve(createIterResultObject(undefined, true)) };
  ...
  return defineBuiltIns(objectCreate(asyncIteratorPrototype), {
    ...
    'return': function () {
      ...
      if (returnMethod === undefined) return Promise$3.resolve(createIterResultObject(undefined, true));
...
createNonEnumerableProperty(AsyncIteratorHelperPrototype, TO_STRING_TAG$8, 'Async Iterator Helper');
...
var asyncIteratorIndexed = function indexed() {
  return functionCall(asyncIteratorMap, this, callback);
};
...
if (!hasOwnProperty_1(asyncIteratorPrototype, ASYNC_DISPOSE$2)) {
  defineBuiltIn(asyncIteratorPrototype, ASYNC_DISPOSE$2, function () {
    var O = this;
...
var notANan = function (it) {
  // eslint-disable-next-line no-self-compare -- NaN check
  if (it === it) return it;
  throw new $RangeError$9('NaN is not allowed');
};
...
var getAsyncIteratorFlattenable = function (obj) {
  ...
  var method = getMethod(object, ASYNC_ITERATOR$3);
  var iterator;
...
_export({ target: 'AsyncIterator', proto: true, real: true }, {
  reduce: function reduce(reducer /* , initialValue */) {
    ...
    return new Promise$5(function (resolve, reject) {
      ...
      var loop = function () {
        try {
          Promise$5.resolve(anObject(functionCall(next, iterator))).then(function (step) {
            try {
              if (anObject(step).done) {
                noInitial ? reject(new $TypeError$r('Reduce of empty iterator with no initial value')) : resolve(accumulator);
              } else {
                var value = step.value;
                if (noInitial) {
                  noInitial = false;
                  ...
                  if (isObject(result)) Promise$5.resolve(result).then(handler, ifAbruptCloseAsyncIterator);
                  else handler(result);
                } catch (error3) { ifAbruptCloseAsyncIterator(error3); }
              }
              counter++;
...
var getInternalState$9 = internalState.getterFor(NUMERIC_RANGE_ITERATOR);
...
var $RangeIterator = iteratorCreateConstructor(function NumericRangeIterator(start, end, option, type, zero, one) {
  ...
  if (typeof start != type || (end !== Infinity && end !== -Infinity && typeof end != type)) {
    throw new $TypeError$s(INCORRECT_RANGE);
  }
  if (start === Infinity || start === -Infinity) {
    throw new $RangeError$a(INCORRECT_RANGE);
  }
...
var addGetter$1 = function (key) {
  defineBuiltInAccessor($RangeIterator.prototype, key, {
    get: function () {
      return getInternalState$9(this)[key];
    },
    set: function () { /* empty */ },
    configurable: true,
    enumerable: false
...
Node.prototype.next = function (i, it, IS_OBJECT) {
  var store = IS_OBJECT
    ...
    : this.primitives || (this.primitives = new Map$5());
...
var compositeKey = function () {
  ...
  if (this === $Object$6 && active === root) throw new $TypeError$t('Composite keys must contain a non-primitive component');
  for (i = 0; i < length; i++) {
...
_export({ global: true, forced: true }, {
  compositeKey: function compositeKey$1() {
    return functionApply(compositeKey, $Object$7, arguments).get('object', initializer);
  }
});
...
var aDataView = function (argument) {
  ...
  throw new $TypeError$u('Argument is not a DataView');
};
...
_export({ target: 'DataView', proto: true }, {
  setFloat16: function setFloat16(byteOffset, value /* , littleEndian */) {
    ...
    var bytes = packIEEE754$1(mathF16round(value), 10, 2);
    return setUint16(this, offset, bytes[1] << 8 | bytes[0], arguments.length > 2 ? arguments[2] : false);
  }
});

// eslint-disable-next-line es/no-typed-arrays -- safe
var setUint8$1 = functionUncurryThis(DataView.prototype.setUint8);
...
_export({ target: 'DataView', proto: true, forced: true }, {
  setUint8Clamped: function setUint8Clamped(byteOffset, value) {
    aDataView(this);
    var offset = toIndex(byteOffset);
    return setUint8$1(this, offset, toUint8Clamped(value));
  }
});
...
var $DisposableStack = function DisposableStack() {
  setInternalState$c(anInstance(this, DisposableStackPrototype), {
...
defineBuiltIns(DisposableStackPrototype, {
  ...
  use: function use(value) {
    addDisposableResource(getPendingDisposableStackInternalState(this), value, HINT$1);
    return value;
  },
  adopt: function adopt(value, onDispose) {
...
defineBuiltIn(DisposableStackPrototype, TO_STRING_TAG$9, DISPOSABLE_STACK, { nonWritable: true });
...
var exec$6 = functionUncurryThis(classRegExp.exec);

var isClassConstructor = function (argument) {
  try {
    // `Function#toString` throws on some built-it function in some legacy engines
    // (for example, `DOMQuad` and similar in FF41-)
    if (!descriptors || !exec$6(classRegExp, inspectSource(argument))) return false;
  } catch (error) { /* empty */ }
  var prototype = getOwnPropertyDescriptor$a(argument, 'prototype');
...
if (FunctionPrototype$5[METADATA] === undefined) {
  defineProperty$9(FunctionPrototype$5, METADATA, {
    value: null
  });
}
...
var NativeIterator = global_1[ITERATOR$8];

// FF56- have non-standard global helper `Iterator`
var FORCED$A =  !isCallable(NativeIterator)
...
var IteratorConstructor = function Iterator() {
  ...
  if (objectGetPrototypeOf(this) === IteratorPrototype$3) throw new $TypeError$v('Abstract class Iterator not directly constructable');
};
  ...
  if (descriptors) {
    defineBuiltInAccessor(IteratorPrototype$3, key, {
      ...
      set: function (replacement) {
        anObject(this);
        if (this === IteratorPrototype$3) throw new $TypeError$v("You can't redefine this property");
...
if (!hasOwnProperty_1(IteratorPrototype$3, TO_STRING_TAG$a)) defineIteratorPrototypeAccessor(TO_STRING_TAG$a, ITERATOR$8);

if (FORCED$A || !hasOwnProperty_1(IteratorPrototype$3, CONSTRUCTOR) || IteratorPrototype$3[CONSTRUCTOR] === Object) {
...
// https://github.com/tc39/proposal-iterator-helpers
_export({ global: true, constructor: true, forced: FORCED$A }, {
...
var createIteratorProxyPrototype = function (IS_ITERATOR) {
  ...
  return defineBuiltIns(objectCreate(IteratorPrototype$4), {
    next: function next() {
      var state = getInternalState(this);
      // for simplification:
...
createNonEnumerableProperty(IteratorHelperPrototype, TO_STRING_TAG$b, 'Iterator Helper');
...
var iteratorIndexed = function indexed() {
  return functionCall(iteratorMap, this, callback$1);
};
...
if (!hasOwnProperty_1(IteratorPrototype$5, DISPOSE$2)) {
  defineBuiltIn(IteratorPrototype$5, DISPOSE$2, function () {
...
var IteratorPrototype$6 = iteratorsCore.IteratorPrototype;
...
_export({ target: 'Iterator', stat: true, forced: isPure }, {
  from: function from(O) {
    ...
    return objectIsPrototypeOf(IteratorPrototype$6, iteratorRecord.iterator)
      ? iteratorRecord.iterator
      : new IteratorProxy$4(iteratorRecord);
  }
});
...
_export({ target: 'Iterator', stat: true, forced: true }, {
  range: function range(start, end, option) {
    ...
    throw new $TypeError$w('Incorrect Iterator.range arguments');
  }
});
...
_export({ target: 'Iterator', proto: true, real: true }, {
  toArray: function toArray() {
    var result = [];
    iterate(getIteratorDirect(anObject(this)), push$h, { that: result, IS_RECORD: true });
    return result;
  }
});
...
var isRawJson = function isRawJSON(O) {
  if (!isObject(O)) return false;
  var state = getInternalState$a(O);
...
var slice$4 = functionUncurryThis(''.slice);
  ...
  while (i < source.length) {
    ...
    if (chr === '\\') {
      ...
      if (hasOwnProperty_1(codePoints, twoChars)) {
        ...
        if (!exec$7(IS_4_HEX_DIGITS, fourHexDigits)) throw new $SyntaxError('Bad Unicode escape at: ' + i);
      ...
      if (exec$7(IS_C0_CONTROL_CODE, chr)) throw new $SyntaxError('Bad control character in string literal at: ' + i);
      value += chr;
      i++;
    }
  }
...
var internalizeProperty = function (object, key, value) {
  if (descriptors) {
    var descriptor = getOwnPropertyDescriptor$b(object, key);
...
Context.prototype = {
  ...
  node: function (type, value, start, end, nodes) {
    return new Node$1(value, end, type ? null : slice$5(this.source, start, end), nodes);
  },
  object: function () {
    var source = this.source;
    var i = this.index + 1;
  ...
  number: function () {
    ...
    else if (exec$8(IS_NON_ZERO_DIGIT, at$1(source, i))) i = this.skip(IS_DIGIT, ++i);
  ...
  keyword: function (value) {
    ...
    if (slice$5(this.source, index, endIndex) !== keyword) throw new SyntaxError$2('Failed to parse value at: ' + index);
    return this.node(PRIMITIVE, value, index, endIndex);
  },
  skip: function (regex, i) {
    var source = this.source;
    for (; i < source.length; i++) if (!exec$8(regex, at$1(source, i))) break;
    return i;
  },
...
var slice$6 = functionUncurryThis(''.slice);
...
_export({ target: 'JSON', stat: true, forced: !nativeRawJson }, {
  rawJSON: function rawJSON(text) {
    ...
    if (jsonString === '' || exec$9(IS_WHITESPACE$1, at$2(jsonString, 0)) || exec$9(IS_WHITESPACE$1, at$2(jsonString, jsonString.length - 1))) {
    ...
    setInternalState$e(obj, { type: 'RawJSON' });
...
// https://tc39.es/ecma262/#sec-json.stringify
// https://github.com/tc39/proposal-json-parse-with-source
if ($stringify$1) _export({ target: 'JSON', stat: true, arity: 3, forced: !nativeRawJson }, {
  stringify: function stringify(text, replacer, space) {
    var replacerFunction = getJsonReplacerFunction(replacer);
    var rawStrings = [];

    var json = $stringify$1(text, function (key, value) {
      // some old implementations (like WebKit) could pass numbers as keys
      var v = isCallable(replacerFunction) ? functionCall(replacerFunction, this, $String$8(key), value) : value;
      return isRawJson(v) ? MARK + (push$j(rawStrings, v.rawJSON) - 1) : v;
    }, space);
    ...
    for (var i = 0; i < length; i++) {
      ...
      if (chr === '"') {
        ...
        var string = slice$6(json, i, end);
        result += slice$6(string, 0, MARK_LENGTH) === MARK
          ? rawStrings[slice$6(string, MARK_LENGTH)]
          : '"' + string + '"';
        i = end;
      } else result += chr;
    }
...
_export({ target: 'Map', stat: true, forced: true }, {
  keyBy: function keyBy(iterable, keyDerivative) {
    var C = isCallable(this) ? this : Map$7;
    var newMap = new C();
...
_export({ target: 'Map', proto: true, real: true, forced: true }, {
  mapValues: function mapValues(callbackfn /* , thisArg */) {
    ...
    mapIterate(map, function (value, key) {
      set$8(newMap, key, boundFunction(value, key, map));
    });
    return newMap;
  }
});
...
_export({ target: 'Map', proto: true, real: true, forced: true }, {
  reduce: function reduce(callbackfn /* , initialValue */) {
    ...
    if (noInitial) throw new $TypeError$y('Reduce of empty map with no initial value');
    return accumulator;
  }
});
...
var has$4 = mapHelpers.has;
var set$a = mapHelpers.set;
...
_export({ target: 'Map', proto: true, real: true, forced: true }, {
  update: function update(key, callback /* , thunk */) {
    ...
    var length = arguments.length;
    aCallable(callback);
    var isPresentInMap = has$4(map, key);
    if (!isPresentInMap && length < 3) {
      throw new $TypeError$z('Updating absent value');
    }
    var value = isPresentInMap ? get$5(map, key) : aCallable(length > 2 ? arguments[2] : undefined)(key, map);
    set$a(map, key, callback(value, key, map));
    return map;
  }
});
...
_export({ target: 'Math', stat: true, forced: true }, {
  clamp: function clamp(x, lower, upper) {
    return min$c(upper, max$7(lower, x));
  }
});
...
var getInternalState$b = internalState.getterFor(SEEDED_RANDOM_GENERATOR);
var $TypeError$B = TypeError;
...
_export({ target: 'Math', stat: true, forced: true }, {
  seededPRNG: function seededPRNG(it) {
    ...
    if (!numberIsFinite(seed)) throw new $TypeError$B(SEED_TYPE_ERROR);
...
var exec$a = functionUncurryThis(valid.exec);
...
_export({ target: 'Number', stat: true, forced: true }, {
  fromString: function fromString(string, radix) {
    var sign = 1;
    if (typeof string != 'string') throw new $TypeError$C(INVALID_NUMBER_REPRESENTATION);
    if (!string.length) throw new $SyntaxError$2(INVALID_NUMBER_REPRESENTATION);
    if (charAt$c(string, 0) === '-') {
      sign = -1;
      string = stringSlice$g(string, 1);
      if (!string.length) throw new $SyntaxError$2(INVALID_NUMBER_REPRESENTATION);
    }
    var R = radix === undefined ? 10 : toIntegerOrInfinity(radix);
    if (R < 2 || R > 36) throw new $RangeError$b(INVALID_RADIX);
    if (!exec$a(valid, string)) throw new $SyntaxError$2(INVALID_NUMBER_REPRESENTATION);
    var parts = split$1(string, '.');
    var mathNum = $parseInt$2(parts[0], R);
    if (parts.length > 1) mathNum += $parseInt$2(parts[1], R) / pow$4(R, parts[1].length);
    if (R === 10 && numberToString$2(mathNum, R) !== string) throw new $SyntaxError$2(INVALID_NUMBER_REPRESENTATION);
    return sign * mathNum;
  }
});
...
var getInternalState$c = internalState.getterFor(OBJECT_ITERATOR);
...
var Subscription = function (observer, subscriber) {
  var subscriptionState = setInternalState$h(this, new SubscriptionState(observer));
  var start;
...
_export({ target: 'Observable', stat: true, forced: true }, {
  from: function from(x) {
    ...
    var observableMethod = getMethod(anObject(x), $$OBSERVABLE$1);
    if (observableMethod) {
...
var store$1 = metadata.store || (metadata.store = new WeakMap$4());

var getOrCreateMetadataMap = function (target, targetKey, create) {
  var targetMetadata = store$1.get(target);
  if (!targetMetadata) {
    if (!create) return;
    store$1.set(target, targetMetadata = new Map$a());
  }
  var keyMetadata = targetMetadata.get(targetKey);
  if (!keyMetadata) {
    if (!create) return;
    targetMetadata.set(targetKey, keyMetadata = new Map$a());
  } return keyMetadata;
};
...
var ordinaryOwnMetadataKeys = function (target, targetKey) {
  ...
  var keys = [];
  if (metadataMap) metadataMap.forEach(function (_, key) { push$k(keys, key); });
  return keys;
};
...
var store$2 = reflectMetadata.store;
...
var ordinaryMetadataKeys = function (O, P) {
  ...
  return pKeys.length ? oKeys.length ? arrayUniqueBy$1(concat$4(oKeys, pKeys)) : pKeys : oKeys;
};
...
_export({ target: 'RegExp', stat: true, forced: true }, {
  escape: function escape(S) {
    ...
    var firstCode = charCodeAt$6(str, 0);
    // escape first DecimalDigit
    return (firstCode > 47 && firstCode < 58 ? '\\x3' : '') + replace$9(str, NEED_ESCAPING, '\\$&');
  }
});
...
var forEach$1 = functionUncurryThis(SetPrototype$1.forEach);
var keys$2 = functionUncurryThis(SetPrototype$1.keys);
var next$1 = keys$2(new Set$1()).next;

var setIterate = function (set, fn, interruptible) {
  return interruptible ? iterateSimple({ iterator: keys$2(set), next: next$1 }, fn) : forEach$1(set, fn);
};
...
var getSetRecord = function (obj) {
  ...
  // eslint-disable-next-line no-self-compare -- NaN check
  if (numSize !== numSize) throw new $TypeError$D(INVALID_SIZE);
  var intSize = toIntegerOrInfinity(numSize);
  if (intSize < 0) throw new $RangeError$c(INVALID_SIZE);
...
var setDifference = function difference(other) {
  ...
  if (setSize(O) <= otherRec.size) setIterate(O, function (e) {
    ...
    if (has$6(O, e)) remove$2(result, e);
  });
  return result;
};
...
var toSetLike = function (it) {
  ...
  return isIterable(it) ? new Set$3(it) : it;
};
...
var setIsDisjointFrom = function isDisjointFrom(other) {
  ...
  return iterateSimple(iterator, function (e) {
    if (has$8(O, e)) return iteratorClose(iterator, 'normal', false);
  }) !== false;
};
...
var setIsSupersetOf = function isSupersetOf(other) {
  ...
  var iterator = otherRec.getIterator();
  return iterateSimple(iterator, function (e) {
    if (!has$9(O, e)) return iteratorClose(iterator, 'normal', false);
  }) !== false;
};
...
_export({ target: 'Set', proto: true, real: true, forced: true }, {
  reduce: function reduce(callbackfn /* , initialValue */) {
    ...
    if (noInitial) throw new $TypeError$E('Reduce of empty set with no initial value');
    return accumulator;
  }
});
...
var setSymmetricDifference = function symmetricDifference(other) {
  ...
  iterateSimple(keysIter, function (e) {
    if (has$a(O, e)) remove$3(result, e);
    else add$5(result, e);
  });
  return result;
};
...
var stringCooked = function cooked(template /* , ...substitutions */) {
  ...
  while (true) {
    ...
    if (nextVal === undefined) throw new $TypeError$F('Incorrect template');
    push$m(elements, toString_1(nextVal));
    if (i === literalSegments) return join$5(elements, '');
    if (i < argumentsLength) push$m(elements, toString_1(arguments[i]));
  }
};
...
var weakMapHelpers = {
  // eslint-disable-next-line es/no-weak-map -- safe
  WeakMap: WeakMap,
  set: functionUncurryThis(WeakMapPrototype$1.set),
  get: functionUncurryThis(WeakMapPrototype$1.get),
  has: functionUncurryThis(WeakMapPrototype$1.has),
  remove: functionUncurryThis(WeakMapPrototype$1['delete'])
};
...
var parseHex = function (str, index, end) {
  ...
  var n = 0;
  for (; index < end; index++) {
    var c = hexToInt(charCodeAt$7(str, index));
    if (c === -1) return -1;
    n = n * 16 + c;
  }
  return n;
...
var stringParse = function (raw) {
  ...
  var i = 0;
  var n;
  while ((i = stringIndexOf$4(raw, '\\', i)) > -1) {
    out += stringSlice$h(raw, start, i);
    // If the backslash is the last char of the string, then it was an invalid sequence.
    // This can't actually happen in a tagged template literal, but could happen if you manually
    // invoked the tag with an array.
    if (++i === raw.length) return;
    var next = charAt$f(raw, i++);
    switch (next) {
      ...
      case '\r':
        ...
        if (i < raw.length && charAt$f(raw, i) === '\n') ++i;
      // break omitted
      case '\n':
      case '\u2028':
      case '\u2029':
  ...
  return out + stringSlice$h(raw, start);
};
...
var $TypeError$G = TypeError;
// eslint-disable-next-line es/no-object-freeze -- safe
var freeze$2 = Object.freeze || Object;
// eslint-disable-next-line es/no-object-isfrozen -- safe
var isFrozen$2 = Object.isFrozen;
var min$d = Math.min;
...
var dedentTemplateStringsArray = function (template) {
  ...
  if (freezing && !isFrozen$2(rawInput)) throw new $TypeError$G('Raw template should be frozen');
  if (weakMapHas(DedentMap, rawInput)) return weakMapGet(DedentMap, rawInput);
  var raw = dedentStringsArray(rawInput);
  var cookedArr = cookStrings(raw);
  defineProperty$a(cookedArr, 'raw', {
    value: freeze$2(raw)
  });
  freeze$2(cookedArr);
...
var dedentStringsArray = function (template) {
  ...
  var blocks = $Array$b(length);
  var dedented = $Array$b(length);
  var i = 0;
  var lines, common, quasi, k;

  if (!length) throw new $TypeError$G(INVALID_TAG);

  for (; i < length; i++) {
    var element = t[i];
    if (typeof element == 'string') blocks[i] = split$2(element, NEW_LINE);
    else throw new $TypeError$G(INVALID_TAG);
  }
  ...
  for (i = 0; i < length; i++) {
    ...
    if (i === 0) {
      if (lines.length === 1 || lines[0].length > 0) {
        throw new $TypeError$G(INVALID_OPENING_LINE);
      }
      lines[1] = '';
    }
    if (lastSplit) {
      if (lines.length === 1 || exec$b(NON_WHITESPACE, lines[lines.length - 1])) {
        throw new $TypeError$G(INVALID_CLOSING_LINE);
      }
    ...
    for (var j = 2; j < lines.length; j += 2) {
      ...
      var leading = exec$b(LEADING_WHITESPACE, text)[0];
  ...
  for (i = 0; i < length; i++) {
    ...
    for (; k < lines.length; k += 2) {
      quasi += lines[k] + stringSlice$i(lines[k + 1], count);
    }
    dedented[i] = quasi;
  }
...
var commonLeadingIndentation = function (a, b) {
  ...
  var i = 0;
  for (var len = min$d(a.length, b.length); i < len; i++) {
    if (charAt$g(a, i) !== charAt$g(b, i)) break;
  }
  return stringSlice$i(a, 0, i);
};

var cookStrings = function (raw) {
  var i = 0;
  var length = raw.length;
  var result = $Array$b(length);
  for (; i < length; i++) {
...
if (Symbol$4) {
  var descriptor = getOwnPropertyDescriptor$c(Symbol$4, 'asyncDispose');
  // workaround of NodeJS 20.4 bug
  // https://github.com/nodejs/node/issues/48699
  // and incorrect descriptor from some transpilers and userland helpers
  if (descriptor.enumerable && descriptor.configurable && descriptor.writable) {
    defineProperty$b(Symbol$4, 'asyncDispose', { value: descriptor.value, enumerable: false, configurable: false, writable: false });
  }
}
...
if (Symbol$5) {
  var descriptor$1 = getOwnPropertyDescriptor$d(Symbol$5, 'dispose');
  // workaround of NodeJS 20.4 bug
  // https://github.com/nodejs/node/issues/48699
  // and incorrect descriptor from some transpilers and userland helpers
  if (descriptor$1.enumerable && descriptor$1.configurable && descriptor$1.writable) {
    defineProperty$c(Symbol$5, 'dispose', { value: descriptor$1.value, enumerable: false, configurable: false, writable: false });
  }
}

var Symbol$6 = getBuiltIn('Symbol');
var keyFor = Symbol$6.keyFor;
var thisSymbolValue$1 = functionUncurryThis(Symbol$6.prototype.valueOf);

// `Symbol.isRegisteredSymbol` method
// https://tc39.es/proposal-symbol-predicates/#sec-symbol-isregisteredsymbol
var symbolIsRegistered = Symbol$6.isRegisteredSymbol || function isRegisteredSymbol(value) {
  try {
...
var getOwnPropertyNames$3 = getBuiltIn('Object', 'getOwnPropertyNames');
var thisSymbolValue$2 = functionUncurryThis(Symbol$7.prototype.valueOf);
var WellKnownSymbolsStore$2 = shared('wks');

for (var i = 0, symbolKeys = getOwnPropertyNames$3(Symbol$7), symbolKeysLength = symbolKeys.length; i < symbolKeysLength; i++) {
  // some old engines throws on access to some keys like `arguments` or `caller`
  try {
    var symbolKey = symbolKeys[i];
    if (isSymbol(Symbol$7[symbolKey])) wellKnownSymbol(symbolKey);
  } catch (error) { /* empty */ }
}
...
var symbolIsWellKnown = function isWellKnownSymbol(value) {
  ...
  try {
    var symbol = thisSymbolValue$2(value);
    for (var j = 0, keys = getOwnPropertyNames$3(WellKnownSymbolsStore$2), keysLength = keys.length; j < keysLength; j++) {
      // eslint-disable-next-line eqeqeq -- polyfilled symbols case
      if (WellKnownSymbolsStore$2[keys[j]] == symbol) return true;
    }
  } catch (error) { /* empty */ }
  return false;
};
...
var exportTypedArrayStaticMethod$3 = arrayBufferViewCore.exportTypedArrayStaticMethod;

// `%TypedArray%.fromAsync` method
// https://github.com/tc39/proposal-array-from-async
exportTypedArrayStaticMethod$3('fromAsync', function fromAsync(asyncItems /* , mapfn = undefined, thisArg = undefined */) {
  var C = this;
  var argumentsLength = arguments.length;
  var mapfn = argumentsLength > 1 ? arguments[1] : undefined;
  var thisArg = argumentsLength > 2 ? arguments[2] : undefined;
  return new (getBuiltIn('Promise'))(function (resolve) {
    ...
    return arrayFromConstructorAndList(aTypedArrayConstructor$4(C), list);
  });
}, true);
...
// https://github.com/tc39/proposal-array-filtering
exportTypedArrayMethod$u('filterOut', function filterOut(callbackfn /* , thisArg */) {
  var list = $filterReject$2(aTypedArray$t(this), callbackfn, arguments.length > 1 ? arguments[1] : undefined);
  return typedArrayFromSpeciesAndList(this, list);
}, true);
...
// https://github.com/tc39/proposal-array-filtering
exportTypedArrayMethod$v('filterReject', function filterReject(callbackfn /* , thisArg */) {
  var list = $filterReject$3(aTypedArray$u(this), callbackfn, arguments.length > 1 ? arguments[1] : undefined);
  return typedArrayFromSpeciesAndList(this, list);
}, true);
...
// https://github.com/tc39/proposal-array-grouping
exportTypedArrayMethod$w('groupBy', function groupBy(callbackfn /* , thisArg */) {
  var thisArg = arguments.length > 1 ? arguments[1] : undefined;
  return arrayGroup(aTypedArray$v(this), callbackfn, thisArg, typedArraySpeciesConstructor);
}, true);
...
exportTypedArrayMethod$x('toSpliced', function toSpliced(start, deleteCount /* , ...items */) {
  var O = aTypedArray$w(this);
  var C = getTypedArrayConstructor$5(O);
  var len = lengthOfArrayLike(O);
  var actualStart = toAbsoluteIndex(start, len);
  var argumentsLength = arguments.length;
  var k = 0;
  ...
  if (argumentsLength === 0) {
    ...
    actualDeleteCount = min$e(max$9(toIntegerOrInfinity(deleteCount), 0), len - actualStart);
    insertCount = argumentsLength - 2;
    if (insertCount) {
...
var aTypedArray$x = arrayBufferViewCore.aTypedArray;
var getTypedArrayConstructor$6 = arrayBufferViewCore.getTypedArrayConstructor;
var exportTypedArrayMethod$y = arrayBufferViewCore.exportTypedArrayMethod;
var arrayUniqueBy$2 = functionUncurryThis(arrayUniqueBy);

// `%TypedArray%.prototype.uniqueBy` method
// https://github.com/tc39/proposal-array-unique
exportTypedArrayMethod$y('uniqueBy', function uniqueBy(resolver) {
  aTypedArray$x(this);
  return arrayFromConstructorAndList(getTypedArrayConstructor$6(this), arrayUniqueBy$2(this, resolver));
}, true);
...
var anObjectOrUndefined = function (argument) {
  ...
  throw new $TypeError$H($String$9(argument) + ' is not an object or undefined');
};
...
var aString = function (argument) {
  ...
  throw new $TypeError$I('Argument is not a string');
};
...
var getAlphabetOption = function (options) {
  ...
  throw new $TypeError$J('Incorrect `alphabet` option');
};
...
if (Uint8Array$2) _export({ target: 'Uint8Array', stat: true, forced: true }, {
  fromBase64: function fromBase64(string /* , options */) {
    ...
    var input = strict ? string : replace$a(string, SPACES, '');

    if (input.length % 4 === 0) {
      if (stringSlice$j(input, -2) === '==') input = stringSlice$j(input, 0, -2);
      else if (stringSlice$j(input, -1) === '=') input = stringSlice$j(input, 0, -1);
    } else if (strict) throw new SyntaxError$3('Input is not correctly padded');

    var lastChunkSize = input.length % 4;

    switch (lastChunkSize) {
      case 1: throw new SyntaxError$3('Bad input length');
    ...
    var at = function (shift) {
      var chr = charAt$h(input, i + shift);
      if (!hasOwnProperty_1(alphabet, chr)) throw new SyntaxError$3('Bad char in input: "' + chr + '"');
      return alphabet[chr] << (18 - 6 * shift);
    };

    for (; i < inputLength; i += 4) {
      var triplet = at(0) + at(1) + at(2) + at(3);
      push$n(bytes, (triplet >> 16) & 255, (triplet >> 8) & 255, triplet & 255);
    }

    var byteLength = bytes.length;

    if (lastChunkSize === 2) {
      if (strict && bytes[byteLength - 2] !== 0) throw new SyntaxError$3(EXTRA_BITS);
      byteLength -= 2;
    } else if (lastChunkSize === 3) {
      if (strict && bytes[byteLength - 1] !== 0) throw new SyntaxError$3(EXTRA_BITS);
      byteLength--;
    }

    return arrayFromConstructorAndList(Uint8Array$2, bytes, byteLength);
  }
});
...
var NOT_HEX = /[^\da-f]/i;
var exec$c = functionUncurryThis(NOT_HEX.exec);
var stringSlice$k = functionUncurryThis(''.slice);

// `Uint8Array.fromHex` method
// https://github.com/tc39/proposal-arraybuffer-base64
if (Uint8Array$3) _export({ target: 'Uint8Array', stat: true, forced: true }, {
  fromHex: function fromHex(string) {
    aString(string);
    var stringLength = string.length;
    if (stringLength % 2) throw new SyntaxError$4('String should have an even number of characters');
    if (exec$c(NOT_HEX, string)) throw new SyntaxError$4('String should only contain hex characters');
    var result = new Uint8Array$3(stringLength / 2);
    for (var i = 0; i < stringLength; i += 2) {
      result[i / 2] = parseInt$1(stringSlice$k(string, i, i + 2), 16);
    }
    return result;
  }
});
...
var anUint8Array = function (argument) {
  ...
  throw new $TypeError$K('Argument is not an Uint8Array');
};

var base64Alphabet$2 = base64Map.i2c;
var base64UrlAlphabet$2 = base64Map.i2cUrl;
...
// https://github.com/tc39/proposal-arraybuffer-base64
if (Uint8Array$4) _export({ target: 'Uint8Array', proto: true, forced: true }, {
  toBase64: function toBase64(/* options */) {
    var array = anUint8Array(this);
    var options = arguments.length ? anObjectOrUndefined(arguments[0]) : undefined;
    var alphabet = getAlphabetOption(options) === 'base64' ? base64Alphabet$2 : base64UrlAlphabet$2;
    ...
    var at = function (shift) {
      return charAt$i(alphabet, (triplet >> (6 * shift)) & 63);
    };
...
// https://github.com/tc39/proposal-arraybuffer-base64
if (Uint8Array$5) _export({ target: 'Uint8Array', proto: true, forced: true }, {
  toHex: function toHex() {
    anUint8Array(this);
    var result = '';
    for (var i = 0, length = this.length; i < length; i++) {
      var hex = numberToString$3(this[i], 16);
...
var remove$4 = weakMapHelpers.remove;
...
var get$6 = weakMapHelpers.get;
var has$c = weakMapHelpers.has;
var set$b = weakMapHelpers.set;
...
var remove$5 = weakSetHelpers.remove;
...
var exec$d = functionUncurryThis(disallowed.exec);
...
var FORCED$B = !BASIC || NO_SPACES_IGNORE || NO_ENCODING_CHECK || NO_ARG_RECEIVING_CHECK || WRONG_ARITY;

// `atob` method
// https://html.spec.whatwg.org/multipage/webappapis.html#dom-atob
_export({ global: true, bind: true, enumerable: true, forced: FORCED$B }, {
  atob: function atob(data) {
    validateArgumentsLength(arguments.length, 1);
    // `webpack` dev server bug on IE global methods - use call(fn, global, ...)
    if (BASIC && !NO_SPACES_IGNORE && !NO_ENCODING_CHECK) return functionCall($atob, global_1, data);
    var string = replace$b(toString_1(data), whitespaces$1, '');
    var output = '';
    var position = 0;
    var bc = 0;
    var length, chr, bs;
    if (string.length % 4 === 0) {
      string = replace$b(string, finalEq, '');
    }
    length = string.length;
    if (length % 4 === 1 || exec$d(disallowed, string)) {
      throw new (getBuiltIn('DOMException'))('The string is not correctly encoded', 'InvalidCharacterError');
    }
    while (position < length) {
      chr = charAt$j(string, position++);
      bs = bc % 4 ? bs * 64 + c2i[chr] : c2i[chr];
      if (bc++ % 4) output += fromCharCode$4(255 & bs >> (-2 * bc & 6));
    } return output;
  }
});
...
var BASIC$1 = !!$btoa && !fails(function () {
  return $btoa('hi') !== 'aGk=';
});
...
var WRONG_ARG_CONVERSION = BASIC$1 && fails(function () {
  return $btoa(null) !== 'bnVsbA==';
});

var WRONG_ARITY$1 = BASIC$1 && $btoa.length !== 1;

// `btoa` method
// https://html.spec.whatwg.org/multipage/webappapis.html#dom-btoa
_export({ global: true, bind: true, enumerable: true, forced: !BASIC$1 || NO_ARG_RECEIVING_CHECK$1 || WRONG_ARG_CONVERSION || WRONG_ARITY$1 }, {
  btoa: function btoa(data) {
    validateArgumentsLength(arguments.length, 1);
    // `webpack` dev server bug on IE global methods - use call(fn, global, ...)
    if (BASIC$1) return functionCall($btoa, global_1, toString_1(data));
    var string = toString_1(data);
    var output = '';
    var position = 0;
    var map = i2c;
    var block, charCode;
    while (charAt$k(string, position) || (map = '=', position % 1)) {
      charCode = charCodeAt$8(string, position += 3 / 4);
      if (charCode > 0xFF) {
        throw new (getBuiltIn('DOMException'))('The string contains characters outside of the Latin1 range', 'InvalidCharacterError');
      }
      block = block << 8 | charCode;
      output += charAt$k(map, 63 & block >> 8 - position % 1 * 8);
    } return output;
  }
});
...
var handlePrototype$1 = function (CollectionPrototype, COLLECTION_NAME) {
  if (CollectionPrototype) {
    ...
    if (CollectionPrototype[ITERATOR$a] !== ArrayValues) try {
      createNonEnumerableProperty(CollectionPrototype, ITERATOR$a, ArrayValues);
    } catch (error) {
...
var ErrorPrototype$1 = Error$1.prototype;
var setInternalState$j = internalState.set;
var getInternalState$e = internalState.getterFor(DOM_EXCEPTION);
var HAS_STACK = 'stack' in new Error$1(DOM_EXCEPTION);
...
var $DOMException = function DOMException() {
  ...
  if (HAS_STACK) {
    ...
    defineProperty$d(this, 'stack', createPropertyDescriptor(1, errorStackClear(error.stack, 1)));
  }
};

var DOMExceptionPrototype = $DOMException.prototype = objectCreate(ErrorPrototype$1);

var createGetterDescriptor = function (get) {
  return { enumerable: true, configurable: true, get: get };
};

var getterFor$2 = function (key) {
...
if (descriptors) {
  ...
  defineBuiltInAccessor(DOMExceptionPrototype, 'code', getterFor$2('code'));
  // `DOMException.prototype.message` getter
  defineBuiltInAccessor(DOMExceptionPrototype, 'message', getterFor$2('message'));
  // `DOMException.prototype.name` getter
  defineBuiltInAccessor(DOMExceptionPrototype, 'name', getterFor$2('name'));
}

defineProperty$d(DOMExceptionPrototype, 'constructor', createPropertyDescriptor(1, $DOMException));

// FF36- DOMException is a function, but can't be constructed
var INCORRECT_CONSTRUCTOR = fails(function () {
  return !(new NativeDOMException() instanceof Error$1);
});

// Safari 10.1 / Chrome 32- / IE8- DOMException.prototype.toString bugs
var INCORRECT_TO_STRING$2 = INCORRECT_CONSTRUCTOR || fails(function () {
  return ErrorPrototype$1.toString !== errorToString || String(new NativeDOMException(1, 2)) !== '2: 1';
});
...
var FORCED_CONSTRUCTOR =  INCORRECT_CONSTRUCTOR;
...
if (INCORRECT_TO_STRING$2 && ( NativeDOMException === PolyfilledDOMException)) {
...
for (var key in domExceptionConstants) if (hasOwnProperty_1(domExceptionConstants, key)) {
  ...
  var descriptor$2 = createPropertyDescriptor(6, constant.c);
  if (!hasOwnProperty_1(PolyfilledDOMException, constantName)) {
    defineProperty$d(PolyfilledDOMException, constantName, descriptor$2);
  }
  if (!hasOwnProperty_1(PolyfilledDOMExceptionPrototype, constantName)) {
    defineProperty$d(PolyfilledDOMExceptionPrototype, constantName, descriptor$2);
  }
}
...
var NativeDOMException$1 = getBuiltIn(DOM_EXCEPTION$1);
...
var $DOMException$1 = function DOMException() {
  ...
  var message = normalizeStringArgument(argumentsLength < 1 ? undefined : arguments[0]);
  var name = normalizeStringArgument(argumentsLength < 2 ? undefined : arguments[1], 'Error');
  var that = new NativeDOMException$1(message, name);
  var error = new Error$2(message);
  error.name = DOM_EXCEPTION$1;
  defineProperty$e(that, 'stack', createPropertyDescriptor(1, errorStackClear(error.stack, 1)));
  inheritIfRequired(that, this, $DOMException$1);
  return that;
};

var DOMExceptionPrototype$1 = $DOMException$1.prototype = NativeDOMException$1.prototype;

var ERROR_HAS_STACK = 'stack' in new Error$2(DOM_EXCEPTION$1);
var DOM_EXCEPTION_HAS_STACK = 'stack' in new NativeDOMException$1(1, 2);

// eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
var descriptor$3 = NativeDOMException$1 && descriptors && Object.getOwnPropertyDescriptor(global_1, DOM_EXCEPTION$1);

// Bun ~ 0.1.1 DOMException have incorrect descriptor and we can't redefine it
// https://github.com/Jarred-Sumner/bun/issues/399
var BUGGY_DESCRIPTOR = !!descriptor$3 && !(descriptor$3.writable && descriptor$3.configurable);

var FORCED_CONSTRUCTOR$1 = ERROR_HAS_STACK && !BUGGY_DESCRIPTOR && !DOM_EXCEPTION_HAS_STACK;

// `DOMException` constructor patch for `.stack` where it's required
// https://webidl.spec.whatwg.org/#es-DOMException-specialness
_export({ global: true, constructor: true, forced:  FORCED_CONSTRUCTOR$1 }, { // TODO: fix export logic
  DOMException: FORCED_CONSTRUCTOR$1 ? $DOMException$1 : NativeDOMException$1
});

var PolyfilledDOMException$1 = getBuiltIn(DOM_EXCEPTION$1);
var PolyfilledDOMExceptionPrototype$1 = PolyfilledDOMException$1.prototype;

if (PolyfilledDOMExceptionPrototype$1.constructor !== PolyfilledDOMException$1) {
  {
    defineProperty$e(PolyfilledDOMExceptionPrototype$1, 'constructor', createPropertyDescriptor(1, PolyfilledDOMException$1));
  }
  ...
  for (var key$1 in domExceptionConstants) if (hasOwnProperty_1(domExceptionConstants, key$1)) {
    ...
    if (!hasOwnProperty_1(PolyfilledDOMException$1, constantName$1)) {
      defineProperty$e(PolyfilledDOMException$1, constantName$1, createPropertyDescriptor(6, constant$1.c));
    }
  }
}
...
setToStringTag(getBuiltIn(DOM_EXCEPTION$2), DOM_EXCEPTION$2);
...
try {
  if (descriptors) {
    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
    var descriptor$4 = Object.getOwnPropertyDescriptor(global_1, 'self');
    // some engines have `self`, but with incorrect descriptor
    // https://github.com/denoland/deno/issues/15765
    if (INCORRECT_VALUE || !descriptor$4 || !descriptor$4.get || !descriptor$4.enumerable) {
      defineBuiltInAccessor(global_1, 'self', {
        get: function self() {
          return global_1;
        },
        set: function self(value) {
          if (this !== global_1) throw new $TypeError$L('Illegal invocation');
          defineProperty$f(global_1, 'self', {
            value: value,
            writable: true,
            configurable: true,
            enumerable: true
...
var push$o = functionUncurryThis([].push);
...
var thisTimeValue$4 = functionUncurryThis(Date$1.prototype.getTime);
...
var FORCED_REPLACEMENT =  !checkErrorsCloning(nativeStructuredClone, Error$3)
...
var cloneBuffer = function (value, map, $type) {
  if (mapHas$2(map, value)) return mapGet$1(map, value);
...
var structuredCloneInternal = function (value, map) {
  ...
  switch (type) {
    case 'Array':
      cloned = Array$3(lengthOfArrayLike(value));
      break;
    case 'Object':
      cloned = {};
      break;
    ...
    default:
      if (nativeRestrictedStructuredClone) {
        ...
        case 'Boolean':
          ...
          break;
        case 'Number':
          cloned = Object$1(thisNumberValue$1(value));
          break;
        case 'String':
          cloned = Object$1(thisStringValue(value));
          break;
        case 'Date':
          cloned = new Date$1(thisTimeValue$4(value));
          break;
        case 'Blob':
          try {
  ...
  switch (type) {
    ...
    case 'Map':
      value.forEach(function (v, k) {
        mapSet$2(cloned, structuredCloneInternal(k, map), structuredCloneInternal(v, map));
      });
      break;
    case 'Set':
...
var tryToTransfer = function (rawTransfer, map) {
  if (!isObject(rawTransfer)) throw new TypeError$7('Transfer option cannot be converted to a sequence');

  var transfer = [];

  iterate(rawTransfer, function (value) {
    push$o(transfer, anObject(value));
  });

  var i = 0;
  var length = lengthOfArrayLike(transfer);
  var buffers = new Set$7();
  ...
  while (i < length) {
    ...
    if (type === 'ArrayBuffer' ? setHas(buffers, value) : mapHas$2(map, value)) {
    ...
    mapSet$2(map, value, transferred);
  }
...
var exec$e = functionUncurryThis(regexSeparators.exec);
...
var ucs2decode = function (string) {
  ...
  while (counter < length) {
    var value = charCodeAt$9(string, counter++);
    if (value >= 0xD800 && value <= 0xDBFF && counter < length) {
      // It's a high surrogate, and there is a next character.
      var extra = charCodeAt$9(string, counter++);
      if ((extra & 0xFC00) === 0xDC00) { // Low surrogate.
        push$p(output, ((value & 0x3FF) << 10) + (extra & 0x3FF) + 0x10000);
      } else {
...
var encode = function (input) {
  ...
  for (i = 0; i < input.length; i++) {
    ...
    if (currentValue < 0x80) {
      push$p(output, fromCharCode$5(currentValue));
    }
  }
  ...
  while (handledCPCount < inputLength) {
    ...
    if (m - n > floor$9((maxInt - delta) / handledCPCountPlusOne)) {
      throw new $RangeError$d(OVERFLOW_ERROR);
    }
    ...
    for (i = 0; i < input.length; i++) {
      ...
      if (currentValue === n) {
        ...
        while (true) {
          ...
          push$p(output, fromCharCode$5(digitToBasic(t + qMinusT % baseMinusT)));
          q = floor$9(qMinusT / baseMinusT);
          k += base;
        }

        push$p(output, fromCharCode$5(digitToBasic(q)));
...
var stringPunycodeToAscii = function (input) {
  var encoded = [];
  var labels = split$3(replace$c(toLowerCase(input), regexSeparators, '\u002E'), '.');
  var i, label;
  for (i = 0; i < labels.length; i++) {
    label = labels[i];
    push$p(encoded, exec$e(regexNonASCII, label) ? 'xn--' + encode(label) : label);
  }
...
var deserialize = function (it) {
  var result = replace$d(it, plus, ' ');
  var bytes = 4;
  try {
    return decodeURIComponent(result);
  } catch (error) {
    while (bytes) {
      result = replace$d(result, percentSequence(bytes--), percentDecode);
    }
    return result;
  }
};
...
var serialize = function (it) {
  return replace$d(encodeURIComponent$1(it), find$1, replacer);
};
...
var URLSearchParamsState = function (init) {
  ...
  if (init !== undefined) {
    ...
    else this.parseQuery(typeof init == 'string' ? charAt$l(init, 0) === '?' ? stringSlice$l(init, 1) : init : toString_1(init));
  }
};
...
URLSearchParamsState.prototype = {
  ...
  parseObject: function (object) {
    ...
    if (iteratorMethod) {
      ...
      while (!(step = functionCall(next, iterator)).done) {
        ...
        ) throw new TypeError$8('Expected sequence with length 2');
        push$q(entries, { key: toString_1(first.value), value: toString_1(second.value) });
      }
    } else for (var key in object) if (hasOwnProperty_1(object, key)) {
      push$q(entries, { key: key, value: toString_1(object[key]) });
    }
  },
      ...
      while (index < attributes.length) {
        ...
        if (attribute.length) {
          ...
          push$q(entries, {
            ...
            value: deserialize(join$7(entry, '='))
          });
        }
      }
    }
  ...
  serialize: function () {
    ...
    while (index < entries.length) {
      entry = entries[index++];
      push$q(result, serialize(entry.key) + '=' + serialize(entry.value));
...
var URLSearchParamsConstructor = function URLSearchParams(/* init */) {
  ...
  var state = setInternalState$k(this, new URLSearchParamsState(init));
...
defineBuiltIns(URLSearchParamsPrototype, {
  ...
  append: function append(name, value) {
    ...
    push$q(state.entries, { key: toString_1(name), value: toString_1(value) });
  ...
  getAll: function getAll(name) {
    ...
    var index = 0;
    for (; index < entries.length; index++) {
      if (entries[index].key === key) push$q(result, entries[index].value);
    }
    return result;
  },
  ...
  set: function set(name, value) {
    ...
    if (!found) push$q(entries, { key: key, value: val });
    if (!descriptors) this.size = entries.length;
    state.updateURL();
  },
...
defineBuiltIn(URLSearchParamsPrototype, ITERATOR$c, URLSearchParamsPrototype.entries, { name: 'entries' });
...
var parseIPv4 = function (input) {
  ...
  for (index = 0; index < partsLength; index++) {
    ...
    radix = 10;
    if (part.length > 1 && charAt$m(part, 0) === '0') {
      radix = exec$f(HEX_START, part) ? 16 : 8;
      part = stringSlice$m(part, radix === 8 ? 1 : 2);
    }
    if (part === '') {
      number = 0;
    } else {
      if (!exec$f(radix === 10 ? DEC : radix === 8 ? OCT : HEX, part)) return input;
      number = parseInt$2(part, radix);
    }
    push$r(numbers, number);
  }
  for (index = 0; index < partsLength; index++) {
    number = numbers[index];
    if (index === partsLength - 1) {
      if (number >= pow$5(256, 5 - partsLength)) return null;
    } else if (number > 255) return null;
  }
  ipv4 = pop(numbers);
  for (index = 0; index < numbers.length; index++) {
    ipv4 += numbers[index] * pow$5(256, 3 - index);
  }
  return ipv4;
};
...
var parseIPv6 = function (input) {
  ...
  var chr = function () {
    return charAt$m(input, pointer);
  };

  if (chr() === ':') {
    if (charAt$m(input, 1) !== ':') return;
    pointer += 2;
    pieceIndex++;
    compress = pieceIndex;
  }
  while (chr()) {
    ...
    if (chr() === '.') {
      ...
      while (chr()) {
        ...
        if (!exec$f(DIGIT, chr())) return;
        while (exec$f(DIGIT, chr())) {
  ...
  // ipv6
    ...
    for (index = 0; index < 8; index++) {
      ...
      if (compress === index) {
        ...
        result += numberToString$4(host[index], 16);
        if (index < 7) result += ':';
      }
    }
    return '[' + result + ']';
...
var isWindowsDriveLetter = function (string, normalized) {
  var second;
  return string.length === 2 && exec$f(ALPHA, charAt$m(string, 0))
    && ((second = charAt$m(string, 1)) === ':' || (!normalized && second === '|'));
};

// https://url.spec.whatwg.org/#start-with-a-windows-drive-letter
var startsWithWindowsDriveLetter = function (string) {
  var third;
  return string.length > 1 && isWindowsDriveLetter(stringSlice$m(string, 0, 2)) && (
    string.length === 2 ||
    ((third = charAt$m(string, 2)) === '/' || third === '\\' || third === '?' || third === '#')
  );
};
...
var URLState = function (url, isBase, base) {
  ...
  if (isBase) {
    ...
    if (failure) throw new TypeError$9(failure);
...
URLState.prototype = {
  ...
  parse: function (input, stateOverride, base) {
    ...
    while (pointer <= codePoints.length) {
      ...
      switch (state) {
        ...
        case SCHEME:
          if (chr && (exec$f(ALPHANUMERIC, chr) || chr === '+' || chr === '-' || chr === '.')) {
            buffer += toLowerCase$1(chr);
          } else if (chr === ':') {
            if (stateOverride && (
        ...
        case SPECIAL_AUTHORITY_SLASHES:
          state = SPECIAL_AUTHORITY_IGNORE_SLASHES;
          if (chr !== '/' || charAt$m(buffer, pointer + 1) !== '/') continue;
          pointer++;
          break;
          ...
          if (chr === '/' || chr === '\\') state = FILE_SLASH;
            ...
            switch (chr) {
              ...
              case '#':
                ...
                break;
              default:
                if (!startsWithWindowsDriveLetter(join$8(arraySlice(codePoints, pointer), ''))) {
                  url.host = base.host;
                  url.path = arraySlice(base.path);
                  url.shortenPath();
                }
        ...
        case FILE_SLASH:
          ...
          if (base && base.scheme === 'file' && !startsWithWindowsDriveLetter(join$8(arraySlice(codePoints, pointer), ''))) {
            if (isWindowsDriveLetter(base.path[0], true)) push$r(url.path, base.path[0]);
          ...
          if (
            ...
            if (isDoubleDot(buffer)) {
              ...
              if (url.scheme === 'file' && !url.path.length && isWindowsDriveLetter(buffer)) {
                ...
                buffer = charAt$m(buffer, 0) + ':'; // normalize windows drive letter
              }
              push$r(url.path, buffer);
            }
            buffer = '';
  ...
  parseHost: function (input) {
    ...
    if (charAt$m(input, 0) === '[') {
      if (charAt$m(input, input.length - 1) !== ']') return INVALID_HOST;
      result = parseIPv6(stringSlice$m(input, 1, -1));
      if (!result) return INVALID_HOST;
      this.host = result;
    // opaque host
    } else if (!this.isSpecial()) {
      if (exec$f(FORBIDDEN_HOST_CODE_POINT_EXCLUDING_PERCENT, input)) return INVALID_HOST;
      result = '';
      codePoints = arrayFrom(input);
      ...
      if (exec$f(FORBIDDEN_HOST_CODE_POINT, input)) return INVALID_HOST;
  ...
  serialize: function () {
    ...
    output += url.cannotBeABaseURL ? path[0] : path.length ? '/' + join$8(path, '/') : '';
  ...
  getPathname: function () {
    var path = this.path;
    return this.cannotBeABaseURL ? path[0] : path.length ? '/' + join$8(path, '/') : '';
  },
  ...
  setSearch: function (search) {
    ...
    if (search === '') {
      ...
      if (charAt$m(search, 0) === '?') search = stringSlice$m(search, 1);
      this.query = '';
  ...
  setHash: function (hash) {
    ...
    if (charAt$m(hash, 0) === '#') hash = stringSlice$m(hash, 1);
    this.fragment = '';
...
var URLConstructor = function URL(url /* , base */) {
  ...
  var state = setInternalState$l(that, new URLState(url, false, base));
  if (!descriptors) {
...
var append = functionUncurryThis(URLSearchParamsPrototype$1.append);
var $delete = functionUncurryThis(URLSearchParamsPrototype$1['delete']);
var forEach$2 = functionUncurryThis(URLSearchParamsPrototype$1.forEach);
...
if (params + '' !== 'a=2') {
  defineBuiltIn(URLSearchParamsPrototype$1, 'delete', function (name /* , value */) {
    var length = arguments.length;
    var $value = length < 2 ? undefined : arguments[1];
    if (length && $value === undefined) return $delete(this, name);
    var entries = [];
    forEach$2(this, function (v, k) { // also validates `this`
      push$s(entries, { key: k, value: v });
    });
...
var getAll = functionUncurryThis(URLSearchParamsPrototype$2.getAll);
var $has = functionUncurryThis(URLSearchParamsPrototype$2.has);
var params$1 = new $URLSearchParams$1('a=1');

// `undefined` case is a Chromium 117 bug
// https://bugs.chromium.org/p/v8/issues/detail?id=14222
if (params$1.has('a', 2) || !params$1.has('a', undefined)) {
  defineBuiltIn(URLSearchParamsPrototype$2, 'has', function has(name /* , value */) {
    var length = arguments.length;
    var $value = length < 2 ? undefined : arguments[1];
...
var URLSearchParamsPrototype$3 = URLSearchParams.prototype;
var forEach$3 = functionUncurryThis(URLSearchParamsPrototype$3.forEach);

// `URLSearchParams.prototype.size` getter
// https://github.com/whatwg/url/pull/734
if (descriptors && !('size' in URLSearchParamsPrototype$3)) {
